...
const OPTIONS: {
...
}[] = [
  {
    ...
    emoji: "🌫️",
    label: "foggy",
    desc: "a bit slow, thoughts aren't connecting",
  },
  {
    value: "wandering",
    emoji: "🦋",
    label: "wandering",
    desc: "jumping around, hard to pin down",
  },
  {
    value: "focused",
    emoji: "🎯",
    label: "focused",
    desc: "clear, ready, I can actually think",
  },
];

const MindStep = ({ onNext }: StepProps) => {
  ...
  const handleSelect = (value: MindState) => {
    setSelected(value);
    setNervousSystemState("mind", value);
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center" }}>
        ...
        >
          Your brain is just being a brain, nothing more 💭
        </motion.p>
      </div>
